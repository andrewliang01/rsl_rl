...
def cteq_pr01_status() -> Mapping[str, Any]:
    ...
    return {
        ...
        "implemented": (
            ...
            "on_policy_runner_termination_provenance_contract",
            "episode_reset_boundary_receipt",
            "termination_reason_audit_receipt",
            "opt_in_isaaclab_pre_reset_extras_bridge",
            "explicit_privileged_gpu_to_cpu_transfer",
            "fully_observed_bins_provider_receipt_contract",
        ),
        "training_ready": False,
        ...
        "blocked_next_steps": (
            "real_anchor_to_boundary_fully_observed_bins_provider",
